...
export function Avatar(props) {
  const { scriptNumber, playAudio } = useChat();
  ...
  const audio = useMemo(() => new Audio(`/audio/mobile3.mp3`));
  const lipsync = JSON.parse(useLoader(THREE.FileLoader, `audio/mobile3.json`));
